...
export default function Home() {
  return (
   <main className='w-screen h-screen relative'>
    <div className='flex items-center w-full h-full bg-cover bg-center'style={{backgroundImage:"url(/my.webp)"}}>
      ...
      <p className='text-gray-200 hidden md:block'>Download the perfect web developer pictures. Find over 100+ of the best free web developer images. Free for commercial use ✓ No attribution required</p>
